...
![sea turtle data](Wk04_StrPops_files/SeaTurtleTitle.png)

---
# Stage structured models: sea turtles

![sea turtle data](Wk04_StrPops_files/SeaTurtleData.png)

--

![sea turtle data](Wk04_StrPops_files/SeaTurtleMatrix.png)

...
![sea turtle data](Wk12_StrPops_files/SeaTurtleTitle.png)

---
# Stage structured models: sea turtles

![sea turtle data](Wk12_StrPops_files/SeaTurtleData.png)

--

![sea turtle data](Wk12_StrPops_files/SeaTurtleMatrix.png)
